    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="/electro-master/img/shop01.png" alt="">
                    </div>
                    <div class="shop-body">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="/electro-master/img/shop03.png" alt="">
                    </div>
                    <div class="shop-body">
            ...
            <div class="col-md-4 col-xs-6">
                <div class="shop">
                    <div class="shop-img">
                        <img src="/electro-master/img/shop02.png" alt="">
                    </div>
                    <div class="shop-body">
                            ...
                            <div class="products-slick" data-nav="#slick-nav-1">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <h3 class="product-name"><a href="/src/Views/client/components/product.php">product name goes here</a></h3>
...
<body onload="loadanh()">
        ...
        <div class="banner">
            <img src="/img/banner1.jpg" id="slideshow">
        </div>
    </div>
    <div>
        <h1>Sản Phẩm</h1>
